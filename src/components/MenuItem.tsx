      ...
      <div className="flex flex-row items-start p-4 gap-4">
        ...
        <div className="relative w-28 shrink-0">
          ...
          <Button
            ...
            size="icon"
            className="absolute bottom-1 right-1 w-9 h-9 p-0 rounded-full bg-gradient-to-br from-red-600 to-black text-white shadow-md hover:scale-105 active:scale-95 transition-transform duration-200"
