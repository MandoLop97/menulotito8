...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-navy-800 text-white py-4 px-5 sticky top-0 z-40">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <div className="font-bold text-2xl text-orange-500">MasPedidos</div>
        ...
        <div className="flex items-center gap-4">
          <button 
            onClick={() => toggleCart()}
            className="relative p-2 rounded-full hover:bg-navy-700 transition-colors"
          >
